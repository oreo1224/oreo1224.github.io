...
# --- 設定 ---
TARGET_URL = "https://transit.yahoo.co.jp/diainfo/114/0"  # 運行情報を確認したいURLに置き換えてください
...
def get_operation_status():
    try:
        ...
        # 運行状況のテキストを取得するための適切なセレクタに変更してください
        # 例: 運行状況が記載されているであろうエリアのクラス名を特定
...
def update_status_file(status):
    ...
    try:
        ...
        print(
            f"[{current_time}] {STATUS_FILE} を更新しました。平常運転: {status['is_normal']}"
        )
